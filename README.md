...
- MCP 看板等大响应依赖云服务器 nginx 对 SSE（`text/event-stream`）开启 gzip（默认不压缩，8.8MB 裸传实测 52s），配置与验证见 [docs/26-09-06-nginx-sse-gzip/deploy-notes-2026-09-06.md](docs/26-09-06-nginx-sse-gzip/deploy-notes-2026-09-06.md)。
