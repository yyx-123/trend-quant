...
> **⚠️ 历史归档（2026-09-23）**：本功能已按架构稿决策 13 整体移除（前后端，
> 见 `docs/26-09-20-投研基建架构/2026-09-21-总体方案设计.md` §8 准备阶段）。
> 本文仅作历史记录；其 `risk_budget` 等风险数学将在 L3 组合策略层的
> sizing 插槽重建（详见该文档 §5.2.4）。`services/manual_trade.py` 的
> 实盘仓位试算器不属于本功能，保留。
>
