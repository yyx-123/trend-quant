...
关键数字（1月=21 交易日；胜率为收益>0 占比；全部组合均值均为正，相对比较才有意义）：

| 组合（日/周/月） | 事件数 | 期间占比 | 1月均值 | 1月胜率 | 2月均值 | 2月胜率 |
|---|---|---|---|---|---|---|
| 正正正 | 16,344 | 2.9% | +2.91% | 49.5% | +4.82% | 47.5% |
| 无正正 | 25,011 | 5.7% | +2.74% | 49.8% | +4.52% | 47.9% |
| 正正无 | 19,321 | 3.0% | +2.28% | 49.0% | +4.22% | 48.8% |
| 无无无 | 113,911 | 34.7% | +1.62% | 50.0% | +3.60% | 50.8% |
| 负负无 | 15,837 | 2.5% | +2.73% | 55.5% | +4.91% | 56.9% |
| 无负负 | 10,062 | 2.1% | +4.96% | 60.6% | +6.36% | 59.4% |
| 正负负 | 4,023 | 0.4% | +5.23% | 62.2% | +5.74% | 58.7% |
| 负负负 | 5,741 | 1.0% | **+4.99%** | **60.3%** | **+7.19%** | **61.3%** |

（完整 27 行见 `data/combo_stats.csv`）
